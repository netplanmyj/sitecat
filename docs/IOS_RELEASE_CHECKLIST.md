...
## Appendix: TestFlight External Tester Message (Build 111)

Title: SiteCat – TestFlight Build 111

Thank you for helping us test SiteCat. This build focuses on stability and performance improvements across site monitoring and link checking.

What’s new:
- Improved reliability in background monitoring and link scan workflows
- UI polish for site management and search
- General performance and crash fixes

What to test:
- Add, edit, and delete sites; verify limits and validation
- Start/stop monitoring and check status updates
- Run a broken link scan and review results
- Use search and statistics to filter and summarize your sites

How to report:
- Use TestFlight “Send Beta Feedback” with screenshots or screen recordings
- Or email: support@netplan.co.jp (include device, iOS version, steps to reproduce)

Notes:
- Large sitemaps may take longer to scan; please report if a scan exceeds 10 minutes
- If you see unexpected errors, try relaunching the app and retrying the action
