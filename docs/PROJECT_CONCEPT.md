...
**現在の状況**: v1.0.3 (Build 41) - App Store配信中（175カ国）

### ビジネスモデル
- **無料版**: 手動監視、1サイト制限、Firebase最小限利用でコスト抑制
- **買い切り版（¥1,220）**: サイト数無制限、除外パス設定、中断・再開機能、履歴50件表示
